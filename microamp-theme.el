...
;; Copyright (C) 2017-2018 Sangho Na <microamp@protonmail.com>
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(aw-leading-char-face ((,class (:foreground ,microamp-red-1 :height 2.5))))
   `(bm-face ((,class (:background ,microamp-orange-1 :foreground ,microamp-main-bg))))
   `(cider-fringe-good-face ((,class (:foreground ,microamp-green-1))))
   `(cursor ((,class (:foreground ,microamp-main-bg :background ,microamp-gray-2))))
   `(default ((,class (:background ,microamp-main-bg :foreground ,microamp-main-fg))))
   `(default-italic ((,class (:italic t))))
   `(eyebrowse-mode-line-active ((,class (:bold t :underline (:color ,microamp-red-1)))))
   ...
   `(git-gutter:added ((,class (:foreground ,microamp-gray-1))))
   `(git-gutter:deleted ((,class (:foreground ,microamp-gray-1 :bold t))))
   `(git-gutter:modified ((,class (:foreground ,microamp-gray-1))))
   ...
   `(highlight-thing ((,class (:background "light gray"))))
   ...
   `(lazy-highlight ((,class (:background ,microamp-gray-2 :foreground ,microamp-main-bg))))
   ...
   `(magit-popup-option-value ((,class (:foreground ,microamp-orange-1))))
   ...
   `(mode-line-inactive ((,class (:line-width 1 :foreground ,microamp-gray-3 :background ,microamp-main-bg :box t))))
   ...
   `(org-agenda-clocking ((,class (:background ,microamp-yellow-1 :bold t))))
   ...
   `(org-done ((,class (:line-width 1 :background ,microamp-main-bg :foreground "red" :bold t :underline t))))
   ...
   `(sh-quoted-exec ((,class (:background nil :foreground ,microamp-red-1))))
